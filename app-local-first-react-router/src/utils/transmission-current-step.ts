...
export function useTransmissionSteps(transmission: CarcasseTransmissionWihMetadata): UseFeiStepsReturn {
  ...
  const memoizedComputeFeiSteps = useMemo(() => {
    return computeTransmissionSteps({
      intermediaires,
      entitiesIdsWorkingDirectlyFor,
      user,
      transmission,
    });
  }, [intermediaires, entitiesIdsWorkingDirectlyFor, user, carcasses, transmission]);
...
export function computeTransmissionSteps({
  intermediaires,
  entitiesIdsWorkingDirectlyFor,
  user,
  transmission,
...
export function getTransportOrSoustraiteLabel(
  ...
  entitiesIdsWorkingDirectlyFor: ReturnType<typeof useEntitiesIdsWorkingDirectlyFor>,
