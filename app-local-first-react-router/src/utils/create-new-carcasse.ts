...
export async function createNewCarcasse({
  ...
  const newCarcasse: Carcasse = {
    ...
    // Ownership fields from FEI
    created_by_user_id: fei.created_by_user_id,
    ...
    fei_current_owner_user_id: fei.fei_current_owner_user_id,
    fei_current_owner_user_name_cache: fei.fei_current_owner_user_name_cache,
    fei_current_owner_entity_id: fei.fei_current_owner_entity_id,
    fei_current_owner_entity_name_cache: fei.fei_current_owner_entity_name_cache,
    fei_current_owner_role: fei.fei_current_owner_role,
    fei_next_owner_wants_to_sous_traite: fei.fei_next_owner_wants_to_sous_traite,
    fei_next_owner_sous_traite_at: fei.fei_next_owner_sous_traite_at,
    fei_next_owner_sous_traite_by_user_id: fei.fei_next_owner_sous_traite_by_user_id,
    fei_next_owner_sous_traite_by_entity_id: fei.fei_next_owner_sous_traite_by_entity_id,
    fei_next_owner_user_id: fei.fei_next_owner_user_id,
    fei_next_owner_user_name_cache: fei.fei_next_owner_user_name_cache,
    fei_next_owner_entity_id: fei.fei_next_owner_entity_id,
    fei_next_owner_entity_name_cache: fei.fei_next_owner_entity_name_cache,
    fei_next_owner_role: fei.fei_next_owner_role,
    fei_prev_owner_user_id: fei.fei_prev_owner_user_id,
    fei_prev_owner_entity_id: fei.fei_prev_owner_entity_id,
    fei_prev_owner_role: fei.fei_prev_owner_role,
