...
export default function LandingDemarchesPage() {
  ...
  return (
    <>
      <title>
        Toutes vos démarches avec Zacharie | Garantir des viandes de gibier sauvage saines et sûres | Ministère de
          ...
          <div className="fr-grid-row fr-grid-row--gutters fr-py-6w my-auto flex flex-col justify-center">
              ...
              <Section title="Qu'est ce que sont les démarches du gibier sauvage ?">
                <div className="my-8 flex flex-col gap-4 md:col-start-2 md:row-span-2 md:row-start-1 md:m-0">
                  <p className="text-justify font-normal text-pretty text-gray-700 [&_b]:font-bold [&_b]:text-gray-900">
                    Pour valoriser la viande de gibier en toute sécurité et en suivant la réglementation en vigueur,
                  ...
                  <p className="text-justify font-normal text-pretty text-gray-700 [&_b]:font-bold [&_b]:text-gray-900">
                    Qu’il s’agisse de la fiche d’examen initial du gibier sauvage, de la formation à l’examen initial ou
                    encore de la déclaration de votre chambre froide, on fait le point sur ce qui vous concerne et les
                    étapes à suivre pour réaliser ces démarches le plus simplement possible.
                  </p>
                </div>
              </Section>
            </section>
            ...
            >
              ...
              <Section title="Qu’est-ce qu’une fiche d’examen initial&nbsp;?">
                <p>
                  ...
                  <b>document réglementaire</b> qui accompagne la ou les carcasses en peau que vous vendez ou donnez à
                  un professionnel ou à une association.
                </p>
                ...
                <ul className="list-inside list-disc">
                  ...
                  <li>
                    assurer <b>la traçabilité</b> des carcasses vendues ou cédées (espèce, numéro d’identification de
                    l’animal, lieu et date de tir).
                  </li>
                </ul>
                <p>
                  En contrôlant les carcasses juste après la chasse, le chasseur formé à l’examen initial apporte des
                  informations sanitaires que les professionnels de la filière ne pourraient pas obtenir autrement.
                </p>
              </Section>
              <Section title="Quand doit-on remplir une fiche d’examen initial&nbsp;?">
                <p>
                  La fiche d’examen initial concerne <b>le grand et le petit gibier</b>. Elle est obligatoire dans les
                  cas de figure suivants&nbsp;:
                </p>
                <ul className="list-inside list-disc">
                  <li>
                    <b>vous vendez vos carcasses</b> à un établissement de traitement du gibier sauvage, à un collecteur
                    professionnel (transporteur) ou à un commerce de détail de proximité (boucherie, restaurant,
                    supermarché).
                  </li>
                  <li>
                ...
                <p>
                  La fiche doit être rédigée <b>immédiatement après l’examen initial</b>, qui est lui-même effectué le
                  plus tôt possible après la chasse. La fiche d’examen initial doit être remplie impérativement{' '}
                  <b>avant le transport des carcasses</b>.
                </p>
              </Section>
              <Section title="Qui peut remplir une fiche d’examen initial&nbsp;?">
                <p>
                  Seul un <b>formateur référent</b> ou un <b>chasseur formé par un formateur référent</b> peut remplir
                  une fiche d’examen initial. À l’issue de la formation, la fédération nationale des chasseurs (FNC) ou
                  la fédération départementale des chasseurs (FDC) délivre aux chasseurs une carte d’examinateur avec un{' '}
              ...
              <Section title="Comment peut-on remplir une fiche d’examen initial&nbsp;?">
                ...
                <p>
                  On peut remplir la fiche d’examen initial sur téléphone, tablette ou ordinateur, grâce à l’application
                  Zacharie. Toutes vos fiches seront enregistrées et accessibles à tout moment. Ce service du Ministère
                  chargé de l’Agriculture est gratuit, facile et rapide d’utilisation. On peut créer son compte sur
                  Zacharie en <Link to="/app/connexion/creation-de-compte">cliquant ici</Link>.
                </p>
                <h4 className="mt-8">
                  En format papier avec le carnet à souches distribué par la Fédération Départementale des Chasseurs
                </h4>
                <p>
                  Il est aussi possible de remplir une fiche d’examen initial en format papier, en utilisant les carnets
                  à souches vendus par votre Fédération Départementale des Chasseurs. Vous devrez remplir une fiche par
                  espèce et attacher la fiche au lot de carcasses concernées. Vous devez conserver le double (papier
                  carbone) 5 ans après la date de mise à mort des carcasses.
                </p>
              </Section>
            </section>
            <section
            ...
            >
              ...
              <Section title="Comment peut-on se former et devenir examinateur initial&nbsp;?">
                <p>
                  Ce sont les Fédération Départementale des Chasseurs (FDC) qui organisent et dispensent les formations
                  auprès des chasseurs qui souhaitent être formés.
                </p>
                <p>
                  Contactez votre{' '}
                  <a
                ...
                <p>
                  À l’issue de la formation, vous recevrez une attestation avec votre numéro d’examinateur initial. Il
                  vous sera demandé lors de votre création de compte Zacharie, si vous souhaitez avoir le rôle
                  d’examinateur initial.
                </p>
              </Section>
            </section>
            <section
            ...
            >
              ...
              <Section title="Qu'est ce qu'un centre de collecte du gibier sauvage dit ‘chambre froide’&nbsp;?">
                <p>
                  Les centres de collecte du gibier sauvage sont des chambres froides dans lesquelles le gibier est
                  regroupé et refroidi avant d'être distribué.
                </p>
                <p>
                  Toute chambre froide où est entreposé du gibier en poils ou en plumes avant qu'il soit cédé ou vendu
                  est considérée comme un centre de collecte du gibier sauvage. Dans ce cas, il doit être déclaré auprès
                  des services de l'État de votre département.
                </p>
              </Section>
              <Section title="Dois-je déclarer la chambre froide où j’entrepose du gibier&nbsp;?">
                <p>
                  ...
                  <b>Centre de Collecte du Gibier sauvage (CCG)</b> et doit être enregistrée auprès des services de
                  l’Etat de votre département (DDPP ou DDETSPP).
                </p>
                <p>
              ...
              <Section title="Comment déclarer sa chambre froide où j’entrepose du gibier&nbsp;?">
                ...
                <p>
                  Après réception de votre demande, les services de l’État vous attribueront un numéro d’enregistrement
                  pour la chambre froide. Ce numéro devra être inscrit sur vos fiches d’examen initial. Dans Zacharie,
                  une fois que vous aurez enregistré votre chambre froide sur votre compte, ce numéro sera
                  automatiquement ajouté aux fiches numériques.
                </p>
                <p className="mt-8">
