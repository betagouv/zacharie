...
export default function EtgFiches() {
  ...
  const [itemsPerPage, setItemsPerPage] = useLocalStorage<number>('etg-fiches-items-per-page', 20);
  ...
  const [filterPremierDetenteur, setFilterPremierDetenteur] = useLocalStorage<string>('etg-fiches-filter-premier-detenteur', '');
  const [filterCCG, setFilterCCG] = useLocalStorage<string>('etg-fiches-filter-ccg', '');
