...
export default function DeactivatedAccount() {
  ...
  return (
    <RootDisplay hideMinistereName navigation={navigation} id="chasseur-layout-not-activated" mainLink="/app/tableau-de-bord">
              ...
              <div className="mb-6 bg-white md:shadow-sm">
                <div className="p-4 md:p-8">
                  <h1 className="fr-h2 fr-mb-2w">
                    {isProfileCompleted ? <>Merci pour votre inscription à Zacharie&nbsp;!</> : <>Pour créer une fiche, compléter votre profil.</>}
                  </h1>
                  {isProfileCompleted ? (
