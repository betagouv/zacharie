      ...
      <div className="fr-grid-row fr-grid-row-gutters fr-grid-row--center">
        <div>
          ...
          <div>
            ...
            <p>
              La plateforme “Zacharie” est éditée par la Direction générale de l’alimentation (DGAL) du ministère de
              l’Agriculture, de la Souveraineté alimentaire et de la Forêt, située :{' '}
            </p>
            <p></p>
            ...
            <p>
              ...
              cette plateforme accessible à toutes et à tous.
            </p>
            <p>
            ...
            <p>
              Pour nous signaler un défaut d’accessibilité vous empêchant d’accéder à un contenu ou une fonctionnalité
              de la plateforme, merci de nous en faire part à l’adresse suivante :{' '}
            ...
            <p>
              En aucun cas, les services associés à la plateforme ne seront à l’origine d’envoi de courriels pour vous
