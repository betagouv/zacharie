...
const advancedFiltersModal = createModal({
  id: 'collecteur-carcasses-advanced-filters',
  isOpenedByDefault: false,
});

const columnsModal = createModal({
  id: 'collecteur-carcasses-columns',
  isOpenedByDefault: false,
});
...
export default function CollecteurCarcasses() {
  ...
  const handleSortBy: typeof setSortBy = (value) => {
    trackFeature('registre-collecteur-carcasses', 'tri');
    setSortBy(value);
  };
  const handleFiltersChange: typeof setFilters = (value) => {
    trackFeature('registre-collecteur-carcasses', 'filtre', 'avance');
    setFilters(value);
  };
  ...
  >('collecteur-carcasses-quick-filter-premier-detenteurs-obj', {});
  ...
  const [visibleColumnKeys, setVisibleColumnKeys] = useLocalStorage<Array<string>>(
    'collecteur-carcasses-visible-columns',
  ...
  const [filterableFields, especeOptions, statusOptions, premierDetenteurOptions, filteredData] =
    useMemo(() => {
      ...
      const _premierDetenteurOptions: Record<
        NonNullable<Carcasse['premier_detenteur_name_cache']>,
        true
      > = {};
      ...
      const seenFei: Record<Carcasse['fei_numero'], true> = {};
      ...
      for (const carcasse of carcassesRegistry) {
        /* create filters */
        if (!seenFei[carcasse.fei_numero]) {
          seenFei[carcasse.fei_numero] = true;
        ...
        if (!filterCarcassesInRegistre(filters)(carcasse, transmissions[getTransmissionId(carcasse)]?.fei))
          continue;
  ...
  useLoaderEffect(() => {
    setLoading(true);
    loadData('collecteur-carcasses').then(() => setLoading(false));
  }, []);
  ...
  const clearAllFilters = () => {
    trackFeature('registre-collecteur-carcasses', 'filtre-reset');
      ...
      <div className="relative">
        ...
        <input
          ...
          onChange={(e) => {
            ...
            trackSearch('registre-collecteur-carcasses');
          }}
          ...
          {FEI_STATUS_OPTIONS.map((status) => (
            ...
            >
              <input
                ...
                onChange={() => {
                  trackFeature('registre-collecteur-carcasses', 'filtre', 'statut-transmission');
                  setQuickFilterFeiStatuses({
                    ...quickFilterTransmissionStatuses,
            ...
            {especeOptions.map((espece) => (
              ...
              >
                <input
                  ...
                  onChange={() => {
                    trackFeature('registre-collecteur-carcasses', 'filtre', 'espece');
                    setQuickFilterEspeces({
                      ...quickFilterEspeces,
            ...
            return (
              ...
              >
                <input
                  ...
                  className="checked:accent-action-high-blue-france h-4 w-4 shrink-0"
                  onChange={() => {
                    trackFeature('registre-collecteur-carcasses', 'filtre', 'statut-carcasse');
                    setQuickFilterStatuses({
                      ...quickFilterStatuses,
            ...
            {Object.keys(premierDetenteurOptions).map((name) => (
              ...
              >
                <input
                  ...
                  className="checked:accent-action-high-blue-france h-4 w-4 shrink-0"
                  onChange={() => {
                    trackFeature('registre-collecteur-carcasses', 'filtre', 'premier-detenteur');
                    setQuickFilterPremierDetenteurs({
                      ...quickFilterPremierDetenteurs,
      ...
      <div className="flex min-h-screen">
        ...
        <div className="min-w-0 flex-1 px-4 pt-4 md:px-6">
                ...
                menuLinks={[
                  {
                    linkProps: {
                      ...
                      onClick: (e) => {
                        ...
                        trackFeature(
                          'registre-collecteur-carcasses',
                          'export',
                          'xlsx',
                          selectedCarcassesIds.length
                        );
          ...
          <CarcassesEspeceSummary
            ...
            storageKey="collecteur-carcasses-espece-summary-open"
          />
            ...
            <div className="flex justify-center overflow-x-auto py-4 sm:justify-start sm:py-6">
              <Pagination
                ...
                getPageLinkProps={(pageNumber) => ({
                  to: `/app/collecteur/carcasses?page=${pageNumber}`,
                })}
              />
            </div>
          </section>
