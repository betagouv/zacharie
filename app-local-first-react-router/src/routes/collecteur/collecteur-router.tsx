...
export default function RouterCollecteur() {
  return (
    <Route path="collecteur" element={<CollecteurLayout />}>
      <Route index element={<CollecteurFiches />} />
      <Route path="contact" element={<Contact />} />
      <Route path="carcasses" element={<CollecteurCarcasses />} />
      <Route path="onboarding" element={<Outlet />}>
        <Route path="coordonnees" element={<CollecteurOnboardingCoordonnees />} />
        <Route path="entreprise" element={<CollecteurOnboardingEntreprise />} />
      </Route>
      <Route path="profil" element={<Outlet />}>
        <Route path="coordonnees" element={<CollecteurProfilCoordonnees />} />
        <Route path="notifications" element={<CollecteurProfilNotifications />} />
        <Route path="partage-de-mes-donnees" element={<CollecteurProfilPartageDeMesDonnees />} />
      </Route>
      <Route path="entreprise" element={<Outlet />}>
        <Route path="informations" element={<CollecteurProfilEntreprise />} />
        <Route path="utilisateurs" element={<CollecteurProfilEntrepriseUtilisateurs />} />
      </Route>
      <Route path="fei/:fei_numero" element={<CollecteurFei />} />
