...
export default function RouterAdmin() {
  return (
    <Route path="admin" element={<AdminLayout />}>
      ...
      <Route path="add-user" element={<AdminNewUser />} />
      <Route path="user/:userId" element={<AdminUser />} />
      <Route path="entities" element={<AdminEntites />} />
      <Route path="add-entity" element={<AdminNouvelleEntite />} />
      <Route path="entity/:entityId" element={<AdminEntity />} />
      <Route path="api-keys" element={<AdminApiKeys />} />
      <Route path="api-key-add" element={<AdminNewApiKey />} />
      <Route path="api-key/:apiKeyId" element={<AdminApiKey />} />
      <Route path="import-ccg" element={<CcgImport />} />
      <Route path="carcasses" element={<AdminCarcasses />} />
      <Route path="carcasse/:zacharie_carcasse_id" element={<AdminCarcasseDetail />} />
    </Route>
  );
}
