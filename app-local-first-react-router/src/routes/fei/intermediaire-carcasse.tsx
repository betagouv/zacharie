            ...
            {carcasse.type === CarcasseType.PETIT_GIBIER && nombreAnimauxTotal > 0 && (
              <div className="mb-4 space-y-4">
                <Input
                  ...
                  nativeInputProps={{
                    ...
                    onChange: (e) => {
                      ...
                      setNombreAnimauxRefuses(nombreRefuses);
                      // Calculer automatiquement le nombre accepté
                      if (nombreRefuses !== null) {
                        setNombreAnimauxAcceptes(Math.max(0, nombreAnimauxTotal - nombreRefuses));
                      } else {
                        setNombreAnimauxAcceptes(null);
                      }
                    },
                  }}
                />
                <Input
                  ...
                  hintText={
                    nombreAnimauxRefuses !== null
                      ? `Nombre d'animaux refusés: ${nombreAnimauxRefuses}`
                      : `Nombre total d'animaux dans le lot: ${nombreAnimauxTotal}`
                  }
                  nativeInputProps={{
                    type: 'number',
                    min: 0,
                    ...
                    onChange: (e) => {
                      ...
                      // Calculer automatiquement le nombre refusé
                      if (nombreAcceptes !== null) {
                        setNombreAnimauxRefuses(Math.max(0, nombreAnimauxTotal - nombreAcceptes));
                      } else {
                        setNombreAnimauxRefuses(null);
                      }
                    },
                  }}
                />
