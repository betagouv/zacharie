...
const partenaireModal = createModal({
  ...
  id: 'partenaire-modal-intermediaire',
});

const ccgModal = createModal({
  isOpenedByDefault: false,
  id: 'ccg-modal-intermediaire',
});

const trichineModal = createModal({
  isOpenedByDefault: false,
  id: 'trichine-modal-intermediaire',
});

interface DestinataireSelectIntermediaireProps {
  className?: string;
  canEdit: boolean;
  disabled?: boolean;
...
export default function DestinataireSelectIntermediaire({
  className = '',
  canEdit,
  disabled,
  feiAndIntermediaireIds,
  intermediaire,
}: DestinataireSelectIntermediaireProps) {
  ...
  // Has depot selection only if intermediaire is not ETG
