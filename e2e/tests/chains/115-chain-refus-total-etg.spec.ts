...
test("ETG refuse toutes les carcasses → chasseur voit refus", async ({ page }) => {
  ...
  await page.getByLabel("Daim - N° MM-001-001").locator(".input-for-search-prefilled-data__input-container").click();
  ...
  await page.getByLabel("Daim - N° MM-001-002").locator(".input-for-search-prefilled-data__input-container").click();
  await page.getByRole("option", { name: "Présence de souillures" }).click();
  ...
  await page.getByLabel("Daim - N° MM-001-004").locator(".input-for-search-prefilled-data__input-container").click();
  await page.getByRole("option", { name: "Présence de souillures" }).click();
  ...
  await page.getByLabel("Pigeons - N° MM-001-").locator(".input-for-search-prefilled-data__input-container").click();
  await page.getByRole("option", { name: "Présence de souillures" }).click();
