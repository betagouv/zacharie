...
if (process.env.NODE_ENV === "production") {
  ...
  /* Access to fetch at 'http://localhost:3233/api/loader/me' from origin 'http://localhost:3232' has been blocked by CORS policy: The value of the 'Access-Control-Allow-Origin' header in the response must not be the wildcard '*' when the request's credentials mode is 'include'. */
