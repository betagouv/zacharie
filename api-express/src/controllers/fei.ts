...
router.post(
    ...
    async (
      ...
      if (body._action === 'delete') {
        if (!existingFei) {
          res
            .status(404)
            .send({ ok: false, data: null, error: 'Fei not found' });
          return;
        }
        const canDelete =
        ...
        if (!canDelete) {
          res
            .status(401)
            .send({ ok: false, data: null, error: 'Unauthorized' });
          return;
        }
      ...
      if (
        ...
        nextFei.heure_mise_a_mort_premiere_carcasse =
          body.heure_mise_a_mort_premiere_carcasse;
      }
      if (
        body.hasOwnProperty(
        ...
        nextFei.heure_evisceration_derniere_carcasse =
          body.heure_evisceration_derniere_carcasse;
      }
      ...
      if (
        body.hasOwnProperty(
          Prisma.FeiScalarFieldEnum.resume_nombre_de_carcasses,
        )
      ) {
      ...
      */
      ...
      if (
        body.hasOwnProperty(
          Prisma.FeiScalarFieldEnum.examinateur_initial_offline,
        )
      ) {
      ...
      if (
        ...
        if (
          body.examinateur_initial_date_approbation_mise_sur_le_marche === ''
        ) {
          nextFei.examinateur_initial_date_approbation_mise_sur_le_marche =
            null;
        } else {
      ...
      */
      ...
      if (
        body.hasOwnProperty(Prisma.FeiScalarFieldEnum.premier_detenteur_user_id)
      ) {
        nextFei.premier_detenteur_user_id =
          body.premier_detenteur_user_id || null;
      }
      if (
        body.hasOwnProperty(Prisma.FeiScalarFieldEnum.premier_detenteur_offline)
      ) {
      ...
      if (
        ...
        nextFei.premier_detenteur_entity_id =
          body.premier_detenteur_entity_id || null;
      }
      if (
        body.hasOwnProperty(
        ...
        nextFei.premier_detenteur_name_cache =
          body.premier_detenteur_name_cache || null;
      }
      if (
        body.hasOwnProperty(
          Prisma.FeiScalarFieldEnum.premier_detenteur_date_depot_quelque_part,
        )
      ) {
      ...
      if (
        ...
        nextFei.premier_detenteur_depot_entity_id =
          body.premier_detenteur_depot_entity_id || null;
      }
      if (
        body.hasOwnProperty(
          Prisma.FeiScalarFieldEnum.premier_detenteur_depot_type,
        )
      ) {
        nextFei.premier_detenteur_depot_type =
          body.premier_detenteur_depot_type || null;
      }
  ...
  */
      ...
      if (
        body.hasOwnProperty(Prisma.FeiScalarFieldEnum.fei_current_owner_user_id)
      ) {
        nextFei.fei_current_owner_user_id =
          body.fei_current_owner_user_id || null;
        if (body.fei_current_owner_role === UserRoles.SVI) {
          nextFei.fei_current_owner_user_id =
            body.fei_current_owner_user_id || null;
          nextFei.fei_current_owner_entity_id =
            body.fei_current_owner_entity_id || null;
        }
      }
      if (
        body.hasOwnProperty(
        ...
        nextFei.fei_current_owner_user_name_cache =
          body.fei_current_owner_user_name_cache || null;
      }
      if (
        body.hasOwnProperty(
          Prisma.FeiScalarFieldEnum.fei_current_owner_wants_to_transfer,
        )
      ) {
        nextFei.fei_current_owner_wants_to_transfer =
          body.fei_current_owner_wants_to_transfer;
      }
      if (
        body.hasOwnProperty(
        ...
        if (!body.fei_current_owner_entity_id) {
          ...
          nextFei.fei_current_owner_entity_id =
            body.fei_current_owner_entity_id;
        }
      }
      if (
        body.hasOwnProperty(
        ...
        nextFei.fei_current_owner_entity_name_cache =
          body.fei_current_owner_entity_name_cache || null;
      }
      if (
      ...
      /*  Next Owner */
      if (
        body.hasOwnProperty(Prisma.FeiScalarFieldEnum.fei_next_owner_user_id)
      ) {
        nextFei.fei_next_owner_user_id = body.fei_next_owner_user_id || null;
      }
      if (
        body.hasOwnProperty(
          Prisma.FeiScalarFieldEnum.fei_next_owner_user_name_cache,
        )
      ) {
        nextFei.fei_next_owner_user_name_cache =
          body.fei_next_owner_user_name_cache || null;
      }
      if (
        body.hasOwnProperty(Prisma.FeiScalarFieldEnum.fei_next_owner_entity_id)
      ) {
        if (!body.fei_next_owner_entity_id) {
          nextFei.fei_next_owner_entity_id = null;
        } else {
          nextFei.fei_next_owner_entity_id =
            body.fei_next_owner_entity_id as string;
          const nextRelation = {
      ...
      if (
        body.hasOwnProperty(
          Prisma.FeiScalarFieldEnum.fei_next_owner_entity_name_cache,
        )
      ) {
        nextFei.fei_next_owner_entity_name_cache =
          body.fei_next_owner_entity_name_cache || null;
      }
      ...
      /*  Prev Owner */
      if (
        body.hasOwnProperty(Prisma.FeiScalarFieldEnum.fei_prev_owner_user_id)
      ) {
        nextFei.fei_prev_owner_user_id = body.fei_prev_owner_user_id || null;
      }
      if (
        body.hasOwnProperty(Prisma.FeiScalarFieldEnum.fei_prev_owner_entity_id)
      ) {
        nextFei.fei_prev_owner_entity_id =
          body.fei_prev_owner_entity_id || null;
      }
  ...
  */
      ...
      if (
        ...
        if (
          feiWithSvi.examinateur_initial_user_id !==
          feiWithSvi.premier_detenteur_user_id
        ) {
      ...
      if (body.fei_next_owner_user_id) {
        ...
        if (nextOwnerId !== user.id) {
          ...
          existingFei.fei_next_owner_user_id !== nextOwnerId
        ) {
      ...
      if (body.fei_next_owner_entity_id) {
        ...
        for (const nextOwner of usersWorkingForEntity) {
          ...
          if (
            existingFei.fei_next_owner_user_id &&
            existingFei.fei_next_owner_user_id !== nextOwner.id
          ) {
            const exNextOwner = await prisma.user.findUnique({
              where: { id: existingFei.fei_next_owner_user_id },
            });
