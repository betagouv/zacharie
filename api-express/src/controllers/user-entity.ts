...
import { EntityRelationType, EntityTypes, Prisma, UserRoles, EntityRelationStatus, Entity, User } from '@prisma/client';
...
const userEntitySchema = z.object({
  ...
  relation: z.enum(Object.values(EntityRelationType) as [EntityRelationType, ...EntityRelationType[]]).optional(),
  status: z.enum(Object.values(EntityRelationStatus) as [EntityRelationStatus, ...EntityRelationStatus[]]).optional(),
});
...
async function checkIfUserCanCrudEntityRelation(body: z.infer<typeof userEntitySchema>, user: User, isAdmin: boolean) {
...
router.post(
  ...
  catchErrors(async (req: RequestWithUser, res: express.Response<UserEntityResponse>, next: express.NextFunction) => {
