...
export const CarcasseBodyZodSchema = z.object({
  ...
  nombre_d_animaux: z.number().optional().nullable(),
  heure_mise_a_mort: z.string().optional().nullable(),
  heure_evisceration: z.string().optional().nullable(),
  heure_mise_a_mort_premiere_carcasse_fei: z.string().optional().nullable(),
  heure_evisceration_derniere_carcasse_fei: z.string().optional().nullable(),
  ...
  examinateur_anomalies_carcasse: z.array(z.string()).optional().nullable(),
  examinateur_anomalies_abats: z.array(z.string()).optional().nullable(),
  examinateur_commentaire: z.string().optional().nullable(),
  examinateur_signed_at: z.string().optional().nullable(),
  premier_detenteur_depot_type: z
  ...
  premier_detenteur_transport_type: z
    .enum(Object.values(TransportType) as [TransportType, ...TransportType[]])
    .optional()
    .nullable(),
  premier_detenteur_transport_date: z.string().optional().nullable(),
  premier_detenteur_prochain_detenteur_role_cache: z
  ...
  intermediaire_carcasse_manquante: z.boolean().optional().nullable(),
  latest_intermediaire_signed_at: z.string().optional().nullable(),
  svi_assigned_to_fei_at: z.string().optional().nullable(),
  svi_carcasse_commentaire: z.string().optional().nullable(),
  svi_carcasse_status: z
    .enum(Object.values(CarcasseStatus) as [CarcasseStatus, ...CarcasseStatus[]])
    .optional()
    .nullable(),
  svi_carcasse_status_set_at: z.string().optional().nullable(),
  svi_ipm1_date: z.string().optional().nullable(),
  svi_ipm1_presentee_inspection: z.boolean().optional().nullable(),
  svi_ipm1_user_id: z.string().optional().nullable(),
  svi_ipm1_user_name_cache: z.string().optional().nullable(),
  svi_ipm1_protocole: z.string().optional().nullable(),
  svi_ipm1_pieces: z.array(z.string()).optional().nullable(),
  svi_ipm1_lesions_ou_motifs: z.array(z.string()).optional().nullable(),
  svi_ipm1_nombre_animaux: z.number().optional().nullable(),
  svi_ipm1_commentaire: z.string().optional().nullable(),
  svi_ipm1_decision: z.string().optional().nullable(),
  svi_ipm1_duree_consigne: z.number().optional().nullable(),
  svi_ipm1_poids_consigne: z.number().optional().nullable(),
  svi_ipm1_poids_type: z.string().optional().nullable(),
  svi_ipm1_signed_at: z.string().optional().nullable(),
  svi_ipm2_date: z.string().optional().nullable(),
  svi_ipm2_presentee_inspection: z.boolean().optional().nullable(),
  svi_ipm2_user_id: z.string().optional().nullable(),
  svi_ipm2_user_name_cache: z.string().optional().nullable(),
  svi_ipm2_protocole: z.string().optional().nullable(),
  svi_ipm2_pieces: z.array(z.string()).optional().nullable(),
  svi_ipm2_lesions_ou_motifs: z.array(z.string()).optional().nullable(),
  svi_ipm2_nombre_animaux: z.number().optional().nullable(),
  svi_ipm2_commentaire: z.string().optional().nullable(),
  svi_ipm2_decision: z.string().optional().nullable(),
  svi_ipm2_traitement_assainissant: z.array(z.string()).optional().nullable(),
  svi_ipm2_traitement_assainissant_cuisson_temps: z.string().optional().nullable(),
  svi_ipm2_traitement_assainissant_cuisson_temp: z.string().optional().nullable(),
  svi_ipm2_traitement_assainissant_congelation_temps: z.string().optional().nullable(),
  svi_ipm2_traitement_assainissant_congelation_temp: z.string().optional().nullable(),
  svi_ipm2_traitement_assainissant_type: z.string().optional().nullable(),
  svi_ipm2_traitement_assainissant_paramètres: z.string().optional().nullable(),
  svi_ipm2_traitement_assainissant_etablissement: z.string().optional().nullable(),
  svi_ipm2_traitement_assainissant_poids: z.number().optional().nullable(),
  svi_ipm2_poids_saisie: z.number().optional().nullable(),
  svi_ipm2_poids_type: z.string().optional().nullable(),
  svi_ipm2_signed_at: z.string().optional().nullable(),
  ...
  current_owner_user_id: z.string().optional().nullable(),
  current_owner_user_name_cache: z.string().optional().nullable(),
  current_owner_entity_id: z.string().optional().nullable(),
  current_owner_entity_name_cache: z.string().optional().nullable(),
  current_owner_role: z
    .enum(Object.values(FeiOwnerRole) as [FeiOwnerRole, ...FeiOwnerRole[]])
    .optional()
    .nullable(),
  next_owner_wants_to_sous_traite: z.boolean().optional().nullable(),
  next_owner_sous_traite_at: z.string().optional().nullable(),
  next_owner_sous_traite_by_user_id: z.string().optional().nullable(),
  next_owner_sous_traite_by_entity_id: z.string().optional().nullable(),
  next_owner_user_id: z.string().optional().nullable(),
  next_owner_user_name_cache: z.string().optional().nullable(),
  next_owner_entity_id: z.string().optional().nullable(),
  next_owner_entity_name_cache: z.string().optional().nullable(),
  next_owner_role: z
    .enum(Object.values(FeiOwnerRole) as [FeiOwnerRole, ...FeiOwnerRole[]])
    .optional()
    .nullable(),
  prev_owner_user_id: z.string().optional().nullable(),
  prev_owner_entity_id: z.string().optional().nullable(),
  prev_owner_role: z
    .enum(Object.values(FeiOwnerRole) as [FeiOwnerRole, ...FeiOwnerRole[]])
    .optional()
    .nullable(),
...
export async function saveCarcasse(
  ...
  let result = CarcasseBodyZodSchema.safeParse(body);
  if (!result.success) {
