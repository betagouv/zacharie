...
export const carcasseForRegistrySelect = {
  ...
  svi_carcasse_saisie_partielle: true,
  svi_carcasse_saisie_partielle_morceaux: true,
  svi_carcasse_saisie_partielle_nombre_animaux: true,
  svi_carcasse_saisie_totale: true,
