...
import etgRouter from './controllers/etg/index.ts';
...
import feiCarcasseIntermediaireRouter from './controllers/carcasse-intermediaire.ts';
...
import v1Router from './controllers/api-external-v1/index.ts';
...
app.use('/etg', passport.initialize(), etgRouter);
...
app.use('/carcasse-intermediaire', passport.initialize(), feiCarcasseIntermediaireRouter);
