  ...
  return [
    {
      ...
      espece: 'Daim',
      examinateur_signed_at: '2025-07-07T14:30:00.000Z',
      examinateur_anomalies_abats: ['Abcès - Système respiratoire (trachée, poumons)'],
      nombre_d_animaux: 1,
      type: CarcasseType.GROS_GIBIER,
      zacharie_carcasse_id: `${feiNumero}_MM-001-001`,
      svi_carcasse_status: CarcasseStatus.SANS_DECISION,
      created_at: '2025-07-07T14:24:19.272Z',
    },
    {
      fei_numero: feiNumero,
      date_mise_a_mort: '2025-07-07T00:00:00.000Z',
      ...
      espece: 'Daim',
      examinateur_anomalies_carcasse: ['Abcès unique - Externe'],
      examinateur_signed_at: '2025-07-07T14:30:00.000Z',
      nombre_d_animaux: 1,
      type: CarcasseType.GROS_GIBIER,
      zacharie_carcasse_id: `${feiNumero}_MM-001-002`,
      svi_carcasse_status: CarcasseStatus.SANS_DECISION,
      created_at: '2025-07-07T14:24:20.272Z',
    },
    {
      fei_numero: feiNumero,
      date_mise_a_mort: '2025-07-07T00:00:00.000Z',
      ...
      svi_carcasse_status: CarcasseStatus.SANS_DECISION,
      created_at: '2025-07-07T14:24:21.272Z',
    },
    {
      fei_numero: feiNumero,
      date_mise_a_mort: '2025-07-07T00:00:00.000Z',
      ...
      svi_carcasse_status: CarcasseStatus.SANS_DECISION,
      created_at: '2025-07-07T14:24:22.256Z',
    },
  ].map((carcasse) => {
    return {
      ...carcasse,
