...
L'objectif est de consolider l'approche "Local-First". Le backend évolue vers un rôle de "Relai de Synchronisation" et de consolidation. L'application mobile reste un encapsuleur Web mais bénéficie de la persistance locale du navigateur.

*Note : Ce schéma est une projection technique susceptible d'évoluer.*

![Architecture Envisagée](img2.png)
...
*Note : L'API Publique n'expose JAMAIS de données personnelles sensibles (téléphone, emails tiers) ni de données techniques internes.*
