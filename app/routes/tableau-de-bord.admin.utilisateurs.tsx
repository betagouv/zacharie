...
import type { AdminUsersLoaderData } from "~/routes/admin.loader.utilisateurs";
...
export async function clientLoader() {
  const response = (await fetch(`${import.meta.env.VITE_API_URL}/admin/loader/utilisateurs`, {
    method: "GET",
    credentials: "include",
    headers: new Headers({
