          ...
          <section className="mt-8 flex flex-col gap-4 md:grid md:grid-cols-2 md:grid-rows-1 md:gap-16">
            ...
            <div className="my-8 md:col-start-1 md:row-start-1 md:m-0">
              ...
              <p className="text-pretty text-justify font-normal text-gray-700 [&_b]:font-bold [&_b]:text-gray-900">
                ...
                d'utilisateurs. 3 établissements de traitement du gibier sauvage agréés participent actuellement à cette
                expérimentation :
                <br />
                ...
                <br />
                <br />
                Toutes les fonctionnalités de Zacharie ne sont pas encore disponibles mais l'outil sera amélioré grâce
                aux retours des premiers utilisateurs. Si le test est concluant, Zacharie sera accessible à l'ensemble
                des chasseurs au cours de l'année 2025.
              </p>
            </div>
          </section>
