...
import type { AdminNouveauUserLoaderData } from "~/routes/api.admin.action.utilisateur.nouveau";
...
export async function clientAction({ request }: ClientActionFunctionArgs) {
  ...
  if (response.ok && response.data) {
    return redirect(`/app/tableau-de-bord/admin/utilisateur/${response.data.id}`);
  }
  return response;
}
