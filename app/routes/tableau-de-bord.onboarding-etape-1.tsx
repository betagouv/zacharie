          ...
          <div className="fr-col-12 fr-col-md-10 fr-col-lg-8">
            <Form id="login_form" method="POST" className="fr-background-alt--blue-france fr-p-16v">
              ...
              <CallOut
                ...
                title="Un seul compte pour toutes vos casquettes">
                Les acteurs de la chasse sont nombreux : examinateur, centre de collecte, etc. et
                parfois vous combinez plusieurs rôles. Zacharie vous permet de jongler entre tous
                très facilement. Lesquels êtes-vous ?
              </CallOut>
              <Checkbox
