...
import type { FeiLoaderData, FeiActionData } from "@api/routes/api.fei.$fei_numero";
import type { CarcasseActionData, CarcasseLoaderData } from "@api/routes/api.fei-carcasse.$fei_numero.$numero_bracelet";
...
} from "@api/routes/api.fei-intermediaire.$fei_numero.$intermediaire_id";
